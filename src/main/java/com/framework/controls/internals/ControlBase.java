...
public class ControlBase  implements Control {
    ...
    @Override
    public ControlBase WaitForBeClickable() {
      DriverContext.WaitForElementBeClickable(getWrappedElement());
      return this;
    }
    ...
    @Override
    public ControlBase ScrollToElement() throws InterruptedException {
        DriverContext.ScrollToElement(element);
        return this;
